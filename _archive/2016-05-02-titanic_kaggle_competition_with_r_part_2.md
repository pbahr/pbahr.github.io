...
{% assign doc_part_1 = site.archive | where: "basename_without_ext", "2016-04-25-titanic_kaggle_competition_with_r_part_1" | first %}
{% assign doc_part_3 = site.archive | where: "basename_without_ext", "2016-05-09-titanic_kaggle_competition_with_r_part_3" | first %}

## Tutorial Table of Contents

* **Part 1**: [Knowing and Preparing the Data](/archive/2016-04-25-titanic-kaggle-competition-with-r-part-1/)
* **Part 2**: Learning From Data
* **Part 3**: [Selecting and Tuning the Model](/archive/2016-05-09-titanic-kaggle-competition-with-r-part-3/)
<hr />

## Machine Learning

In [part 1](/archive/2016-04-25-titanic-kaggle-competition-with-r-part-1/) of this tutorial, we analyzed the data and prepared it for machine learning. Now, we are ready for some action.
...
We will look into this issue in [part 3](/archive/2016-05-09-titanic-kaggle-competition-with-r-part-3/).
