...
{% assign doc_part_2 = site.archive | where: "basename_without_ext", "2016-05-02-titanic_kaggle_competition_with_r_part_2" | first %}

## Tutorial Table of Contents

* **Part 1**: [Knowing and Preparing the Data](/archive/2016-04-25-titanic-kaggle-competition-with-r-part-1/)
* **Part 2**: [Learning From Data](/archive/2016-05-02-titanic-kaggle-competition-with-r-part-2/)
* **Part 3**: Selecting and Tuning the Model
<hr />

In [part 2]({{ doc_part_2.url }}), we tried different models to predict passenger survival on Titanic. We know that an increase in training accurracy, does not always result in increase in the Kaggle score. Herein, we discuss more details.
